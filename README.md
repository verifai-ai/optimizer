...
# Signup or signin to verifai , create ~/.verifai license file
```bash
python3 signup.py

# OR, if you already have a verifai account, signin
python3 signin.py

# OR Download .verifai file from the webApp --> Settings --> Download .verifai file

```

## Example 1 Run the sample optimizer example (test the flow, optional)
...
## You can specify the simulator command "--sim_command xrun -64bit"
## Default is : "xrun -64bit"
